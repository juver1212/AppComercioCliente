package com.innovation.techology.helper;
...
import com.innovation.techology.activity.DrawerActivity;
import com.innovation.techology.model.OrderTracker;
...
public class ApiConfig {
        ...
        if (AppController.isConnected(activity)) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    Log.e("RequestToVolley", url + " == " + response);
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Log.e("Respuesta error", VolleyErrorMessage(error));
                            if (isprogress)
                                progressDisplay.hideProgress();
                ...
                public Map<String, String> getHeaders() {
                    ...
                    Log.e("getHeaders", params1.toString());
                    return params1;
                }
    ...
    public static boolean CheckValidattion(String item, boolean isemailvalidation, boolean ismobvalidation) {
        if (item.length() == 0)
            ...
            return true;
        else return ismobvalidation && (item.length() < 9 || item.length() > 12);
    }
