...
public class ReferEarnActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtrefercoin.setText("Recomienda a un amigo y gana hasta " + preText + "cuando el primer pedido de su amigo se entregue con éxito. La cantidad mínima de pedido debe ser " + Constant.SETTING_CURRENCY_SYMBOL + Constant.REFER_EARN_ORDER_AMOUNT + ". que te permite ganar hasta " + Constant.SETTING_CURRENCY_SYMBOL + Constant.MAX_EARN_AMOUNT + ".");
